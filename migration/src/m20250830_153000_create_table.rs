    ...
    manager
      .create_table(
        Table::create()
          ...
          .col(integer_null(Music::DiskNumber))
          .col(integer_null(Music::TrackNumber))
          .col(date_null(Music::ReleaseDate))
          .col(integer_null(Music::Year))
    ...
    manager
      .create_table(
        Table::create()
          ...
          .col(date_null(MusicPlaylist::ReleaseDate))
          .col(integer_null(MusicPlaylist::Year))
    ...
    manager
      .create_table(
        Table::create()
          ...
          .col(date_null(Movie::ReleaseDate))
